    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
						...
						<div class="dropdown">
                        <li class="nav-item"><a class="nav-link" data-toggle="collapse" href="#pageSubmenu1">My Account</a>
                       
					<ul class="dropdown-menu" id="pageSubmenu1">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#">
						...
						<p><a href="index.php?logout='1'" style="color: red;">&nbsp&nbsp&nbsp&nbspLog Out</a> </p></a></li>
					
						
					<br>
                    <li>
                        <a class="nav-link js-scroll-trigger" href="employee-payroll.php"> Employee Payroll</a>
                    </li>
                   <br>
                    <li>
                        <a class="nav-link js-scroll-trigger" href="invoices.php"> Invoices</a>
                    </li>
					<br>
                    <li>
                        <a class="nav-link js-scroll-trigger" href="payments.php"> Payments</a>
                    </li>
					<br>
	 ...
	 <?php }?>
				<?php else if( !isset($_SESSION['username'])){
						?>
						<li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=login">Log in</a></li>
						<?php }	 ?>
