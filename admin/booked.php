						...
						<?php
						 ...
						 <tr>
						 	...
						 	<td>
								...
								<p><small>Status :<b><?php echo $row['status'] ?></small></b></p>
								<p><small>Account# :<b><?php echo $row['card_number'] ?></small></b></p>
						 	</td>
						 	<td>
						 		<div class="row">
						 		<div class="col-sm-4">
						 	...
						 	<td class="text-center">
						 			...
						 			<a href='del_booking.php?data-id=<?php echo $row['bid'] ?>' ><button class="btn btn-outline-danger btn-sm delete_booked" type="button" data-id="<?php echo $row['bid'] ?>"><i class="fa fa-trash"></i></button></a>
						 		<a href='confirm_booking.php?data-id=<?php echo $row['bid'] ?>'><button class="btn btn-outline-danger btn-sm confirm_booked" type="button" data-id="<?php echo $row['bid'] ?>"><i class="fa fa-check"></i></button>
							</td>
...
<script>
	...
	$('.confirm_booked').click(function(){
		_conf("Confirm Booking?","confirm_booked",[$(this).attr('data-id')])
	})
