            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
						...
						if(isset($_SESSION['username'])){?>
						<div class="dropdown">
                        <li class="nav-item"><a class="nav-link" data-toggle="collapse" href="#pageSubmenu1">My Account</a></li>
                    ...
                    <li>
                        <a class="nav-link js-scroll-trigger" href="#"><?php echo $_SESSION['username'];?></a>
                    </li>
                  
                    <li>
                        <a class="nav-link js-scroll-trigger" href="user/index.php"> Dashboard</a>
                    </li>
					<li>
                        <a class="nav-link js-scroll-trigger" href="index.php?logout='1'"> Log Out</a>
                    </li>
